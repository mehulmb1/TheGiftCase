...
function Login() {
    ...
    <div class="flex flex-col w-half md:w-1/2">
        <div class="flex justify-center pt-12 md:justify-start md:pl-12 md:-mb-24">
            <Link to={'/'} class="p-4 text-xl font-bold text-white bg-black">
                The GiftCase.
            </Link>
        </div>
            ...
            <p class="text-3xl text-center">
                Welcome.
                    ...
                    <div class="flex flex-col pt-4 mb-12">
                        ...
                        <button onClick={login} type="submit" class="w-full px-4 py-2 text-base font-semibold text-center text-white transition duration-200 ease-in bg-black shadow-md hover:text-black hover:bg-white focus:outline-none focus:ring-2">
                            <span class="w-full" >
                                Submit
                            </span>
                        </button>
