...
const EmptyOrder = () => {
    ...
    return (
        <div className="flex items-center flex-col justify-center lg:flex-row py-28 px-6 md:px-24 md:py-20 lg:py-32 gap-16 lg:gap-28">
            ...
            <div className="w-full lg:w-1/2">
                <h1 className="py-4 text-3xl lg:text-4xl font-extrabold text-gray-800">Your Order List Is Currently Empty!</h1>
                <p className="py-2 text-base text-gray-800">Start exploring our collection now and discover the perfect treasures to Order.</p>
                <Link 
                    to={'/'} 
