  ...
  return (
    ...
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            ...
            <div>
                <p className="text-sm font-semibold tracking-widest text-gray-400 uppercase">Contact information</p>

                <ul className="mt-6 space-y-4">
                    <li>
                        <p href="#" title="" className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Trade name: The Giftcase </p>
                    </li>

                    <li>
                        <a href="#" title="" className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600">Phone number: 9028884038 </a>
                    </li>

                    <li>
                        <a type='gmail' href="the.giftcase1@gmail.com" title="" className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Email: the.giftcase1@gmail.com</a>
                    </li>

                    {/* <li>
                        <Link to={'/UserProfile'} href="#" title="" className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Physical address: DP Enterprises, C/o Mahadev Puliwale, Plot No 12 , , Near Kala Maroti Mandir , 440027 Nagpur MH, India</Link>
                    </li> */}
                </ul>
            </div>
